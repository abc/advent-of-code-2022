...
Console.WriteLine($"Day 6 Task 2 Answer: {Day6.Part2Solution()}");
Console.WriteLine();
Console.WriteLine($"Day 7 Task 1 Answer: {Day7.Part1Solution()}");
Console.WriteLine($"Day 7 Task 2 Answer: {Day7.Part2Solution()}");